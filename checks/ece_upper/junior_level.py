...
# Define a ucheck to see if the course is at the junior level
...
def is_junior_level( class_obj: Class ) -> bool:
    ...
    if ( "ECE" in class_obj.all_departments ) and \
       ( int( class_obj.course_number ) >= 3000 ) and \
...
# of is_junior_level with named parameters)

uchecks_to_run: Dict[Callable[[Class], bool], str] = {
    is_junior_level: "Class isn't a valid 3000+ ECE technical elective"
}
